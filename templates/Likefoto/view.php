        ...
        <?php foreach ($foto as $fotoItem) : ?>
            <div class="col-md-4 mb-4">
                <div class="card">
                    ...
                    <td>
                    <?php if ($userLiked): ?>
                        <?= $this->Form->postLink(__('Tidak Suka'), ['controller'=>'Likefoto', 'action' =>'delete', $likeId], ['confirm' => __('Are you sure you want to unlike this photo?'), 'class' => 'btn btn-danger', 'id' => 'likeButton_'.$fotoItem->id]) ?>
                    <?php else: ?>
                        <?= $this->Form->create(null, ['url' => ['controller'=>'Likefoto', 'action' =>'add'],'role'=>'form']) ?>
                            <div class="ml-auto">
                                <?= $this->Form->button(__('Suka'), ['class' => 'btn btn-primary', 'onclick' => 'toggleLikeButton("likeButton_'.$fotoItem->id.'")', 'id' => 'likeButton_'.$fotoItem->id]) ?>
